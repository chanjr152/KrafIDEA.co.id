$.fn.memenu=function(e){
	...
	function i(){
		$(".memenu li").bind("mouseover",function(){
			$(this).children(".dropdown, .mepanel").stop().fadeIn(t.interval)}).bind("mouseleave",function(){$(this).children(".dropdown, .mepanel").stop().fadeOut(t.interval)})
	}
	function s(){
	...
	function o(){
		...
		$(".memenu > li.showhide").bind("click",function(){
			...
			{
				$(".memenu > li:not(.showhide)").slideUp(300);$(".memenu > li.showhide").show(0);
			}
		})
	}
	function u(){
